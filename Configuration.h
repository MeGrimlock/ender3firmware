...
#define CUSTOM_MACHINE_NAME "Grayskull"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 101 } //Adjusted for Greyskull metal extruder
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -6.5, 0 } //Adjusted Roughly in order to prevent breaking the probe by accident
